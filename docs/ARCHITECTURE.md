...
- `Client`: UUID, name, unique document, timestamps, and contracts.
...
The repository contains four incremental migrations: client creation, contract creation, contract soft deletion, and the status/due-date expiration index.
